...
<?php
	...
	{
		$op = array('per','img_pro','pro','port','emp','edu','img_cov');
	}
                	...
                	<!-- form panel -->
						...
						?>
                          <div class="panel panel-default">
                            <div class="panel-heading project_list_heading_bar project_title_outline_userdetails">
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <form action="#" class="form-horizontal" role="form" method="post">                                  
                                    ...
                                    <div class="col-md-8">
                                      <input type="file" name="pro_pic" id="proFileToUpload" class="form-control pp_form_file_upload">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="col-md-offset-3 col-md-8 proCropPicture upload-modal-propic">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="hidden" id="pro_h" name="h" /></label>
                                      <input type="button" onclick="uploadProFile();" name="profile picture" value="Upload" id="proUploadButton" class="btn btn-lg btn-success">
						      		  <input type="button" name="crop file" value="Crop" id="proCropButton" class="btn btn-lg btn-success">
                                    </div>
                                  </div>
                                </form>
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse in">
                              <div class="panel-body">
                                ...
                                <form action="#" class="form-horizontal" role="form" method="post">                                  
                                    ...
                                    <div class="col-md-8">
                                      <input type="file" name="cov_pic" id="covFileToUpload" class="form-control pp_form_file_upload">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="col-md-12 covCropPicture upload-modal-covpic">
                                      
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="col-md-offset-3 col-md-8">
                                    <input type="hidden" id="cov_x" name="x" /></label>
                                    <input type="hidden" id="cov_y" name="y" /></label>
                                    <input type="hidden" id="cov_x2" name="x2" /></label>
                                    <input type="hidden" id="cov_y2" name="y2" /></label>
                                    <input type="hidden" id="cov_w" name="w" /></label>
                                    <input type="hidden" id="cov_h" name="h" /></label>
                                      <input type="button" onclick="uploadCovFile();" name="cover picture" value="Upload" id="covUploadButton" class="btn btn-lg btn-success">
						      		  <input type="button" name="crop file" value="Crop" id="covCropButton" class="btn btn-lg btn-success">
                                    </div>
                                  </div>
                                </form>
