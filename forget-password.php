				...
				<div class="login-box">
					<div class="col-md-12">
						<div class="forgetheading">
							Just put your email id and we will send the new password to your mail.
						</div>
					</div>
						<div class="col-md-10">
							<form class="form-horizontal" role="form" action="v-includes/class.formData.php" method="post">
						  ...
						  <div class="form-group btn-center">
							...
							<div class="col-md-4">
								<input type="hidden" name="fn" value="<?php echo md5('forgot-password') ?>" />
