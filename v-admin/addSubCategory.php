	...
	?>
        <div id="page-wrapper">
            ...
            <?php
             		...
             		$subcat = $manageContent->getAdminSelectedDetails('subcategory','subCategoryId',$_GET['id']);
            ?>
            <!-- /.row -->
            <div class="row">
            	<div class="col-lg-12">
                	<div class="panel panel-default">
                        <div class="panel-heading"><i class="fa fa-plus-circle fa-fw"></i> Edit Sub-Category</div>
                        <div class="panel-body">
                        	<form action="v-includes/class.formData.php" role="form" method="post">
                                <div class="form-group">
                                    <label class="control-label p_label col-sm-3">Sub-Category Name</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" name="name" value="<?php echo $subcat[0]['name'] ?>"/>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-7 col-sm-offset-3">
                                    	...
                                    	<input type="hidden" name="fn" value="<?php echo md5('edit_subcategory') ?>" />
